...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="active"><a href="users.jsp"><i class="fa fa-users"></i> <span>Users</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <thead>
      <tr>
        ...
        <th>Email</th>
        <th>Phone No.</th>
        <th>Click to see all details</th>
        <th>Click to block</th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td>username</td>
        <td><input type="button" class="btn btn-primary btn-sm" value="All Details"></td>
        <td><input type="button" data-toggle="modal" data-target="#modal1" class="btn btn-danger btn-sm" value="Block"></td>
         
    <div class="modal modal-info" id="modal1">
      ...
      <tr>
        ...
        <td>username</td>
          <td><input type="button" class="btn btn-primary btn-sm" value="All Details"></td>
           <td><input type="button" class="btn btn-danger btn-sm" value="Block"></td>
      </tr>
      <tr>
        <td>username</td>  
        <td>July</td>
